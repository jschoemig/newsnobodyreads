...
class NavBar extends Component {
    ...
    handleSubmit(){
        this.props.ComponentDidMount(this.state.inputValue);  //takes in inputValue and sends it to addTodo function in TodoList -> can access it via passed props (from parent to child!)
    }
